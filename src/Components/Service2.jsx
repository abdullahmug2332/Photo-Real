  ...
  return (
    <section className=" w-[97%] 2xl:w-[75%] mx-auto my-[90px]  py-[20px] px-[40px]">
      ...
      <div>
        ...
        <div>
          <p className="p pf">Get photos for these types of ID in 5 minutes:</p>
        ...
        <div>
          <p className="p pf">P.S. We don’t make IDs! We only make photos for IDs. <br />Thank you!</p>
        </div>
      </div>
    </section>
  );
